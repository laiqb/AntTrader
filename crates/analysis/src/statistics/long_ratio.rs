...
use ant_model::{enums::OrderSide, position::Position};
...
#[cfg_attr(
    feature = "python",
    pyo3::pyclass(module = "ant_trader.core.ant_pyo3.analysis")
)]
...
mod tests {
    ...
    use ant_core::{UnixNanos, approx_eq};
    use ant_model::{
        enums::OrderSide,
        identifiers::{
    ...
    fn create_test_position(side: OrderSide) -> Position {
        Position {
            ...
            entry: side,
            side: ant_model::enums::PositionSide::NoPositionSide,
            signed_qty: 0.0,
