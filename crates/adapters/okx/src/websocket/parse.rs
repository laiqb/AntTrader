...
use crate::{
    ...
    websocket::messages::{ExecutionReport, AntWsMessage, OKXFundingRateMsg},
};

/// Parses vector of OKX book messages into ant order book deltas.
...
/// Parses vector of OKX ticker messages into ant quote ticks.
...
/// Parses vector of OKX book messages into ant quote ticks.
...
/// Parses vector of OKX trade messages into ant trade ticks.
...
/// Parses vector of OKX mark price messages into ant mark price updates.
...
/// Parses vector of OKX index price messages into ant index price updates.
...
/// Parses vector of OKX funding rate messages into ant funding rate updates.
...
/// Parses vector of OKX candle messages into ant bars.
...
/// Parses vector of OKX book messages into ant depth10 updates.
...
/// Parses an OKX book message into ant order book deltas.
...
/// Parses an OKX book message into a ant quote tick.
...
/// Parses an OKX book message into a ant [`OrderBookDepth10`].
///
...
/// Parses an OKX ticker message into a ant quote tick.
...
/// Parses an OKX trade message into a ant trade tick.
...
/// Parses an OKX mark price message into a ant mark price update.
...
/// Parses an OKX index price message into a ant index price update.
...
/// Parses an OKX candle message into a ant bar.
...
/// Parses vector of OKX order messages into ant execution reports.
...
/// Parses an OKX order message into a ant order status report.
...
/// Parses an OKX order message into a ant fill report.
...
/// Parses OKX WebSocket message payloads into ant data structures.
///
/// # Panics
///
...
pub fn parse_ws_message_data(
    ...
    match channel {
        ...
        OKXWsChannel::BboTbt => {
            ...
            Ok(Some(AntWsMessage::Data(data_vec)))
        }
        ...
        OKXWsChannel::FundingRate => {
            ...
            Ok(Some(AntWsMessage::FundingRates(data_vec)))
        }
...
mod tests {
    ...
    fn test_parse_ws_account_message() {
        ...
        let ts_init = ant_core::nanos::UnixNanos::default();
