...
use ant_core::{UUID4, python::to_pyruntime_err};
use ant_model::identifiers::{ActorId, TraderId};
use ant_system::get_global_pyo3_registry;
use pyo3::{
...
impl LiveNode {
    ...
    fn py_add_actor_from_config(
        ...
        let actor_id = Python::with_gil(
            |py| -> anyhow::Result<ant_model::identifiers::ActorId> {
...
#[derive(Debug)]
#[pyclass(name = "LiveNodeBuilder", module = "ant_trader.live", unsendable)]
