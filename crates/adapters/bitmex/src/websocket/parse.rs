...
/// Parse a BitMEX WebSocket order message into a ant `OrderStatusReport`.
///
/// # Panics
///
...
/// Parse a BitMEX WebSocket order update message into a ant `OrderUpdated` event.
///
...
pub fn parse_order_update_msg(
    ...
    Some(ant_model::events::OrderUpdated::new(
        trader_id,
        strategy_id,
        instrument_id,
        client_order_id,
...
/// Parse a BitMEX WebSocket execution message into a ant `FillReport`.
///
/// # Panics
///
/// Panics if required fields are missing or invalid.
...
/// Parse a BitMEX WebSocket position message into a ant `PositionStatusReport`.
///
/// # References
///
