...
//! Blockchain data adapter for [antTrader](http://anttrader.io).
//!
//! The `ant-blockchain` crate provides a high-performance, universal, extensible adapter for ingesting
