...
/// Provides a configuration for a Tarid Machine -> ant data -> Parquet replay run.
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct TardisReplayConfig {
    /// The Tardis Machine websocket url.
    pub tardis_ws_url: Option<String>,
    /// If symbols should be normalized with ant conventions.
    pub normalize_symbols: Option<bool>,
    /// The output directory for writing ant format Parquet files.
