...
use ant_model::identifiers::{ComponentId, TraderId};
use ustr::Ustr;
...
pub trait Component {
    ...
    fn start(&mut self) -> anyhow::Result<()> {
        self.transition_state(ComponentTrigger::Start)?; // -> Starting  启动 设置为 Starting
        ...
        self.transition_state(ComponentTrigger::StartCompleted)?; // Starting 设置为 StartCompleted
