...
mod tests {
    ...
    fn test_ant_message_variants() {
        ...
        let error_msg = AntWsMessage::Error(error);
        ...
        for raw_data in raw_scenarios {
            let raw_msg = AntWsMessage::Raw(raw_data.clone());

            match raw_msg {
                AntWsMessage::Raw(data) => {
