...
//! Configuration types for live ant system nodes.
...
use ant_system::config::AntKernelConfig;
...
/// Configuration for live ant system nodes.
#[derive(Debug, Clone)]
...
impl AntKernelConfig for LiveNodeConfig {
    ...
    fn streaming(&self) -> Option<ant_persistence::config::StreamingConfig> {
