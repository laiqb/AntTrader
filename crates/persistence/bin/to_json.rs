...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    match data_type {
        antDataType::QuoteTick => process_data::<QuoteTick>(file_str, &mut session)?,
        antDataType::TradeTick => process_data::<TradeTick>(file_str, &mut session)?,
        antDataType::Bar => process_data::<Bar>(file_str, &mut session)?,
        antDataType::OrderBookDelta => process_data::<OrderBookDelta>(file_str, &mut session)?,
