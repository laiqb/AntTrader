...
[![Documentation](https://img.shields.io/docsrs/ant-bitmex)](https://docs.rs/ant-bitmex/latest/ant-bitmex/)
[![crates.io version](https://img.shields.io/crates/v/ant-bitmex.svg)](https://crates.io/crates/ant-bitmex)
...
[antTrader](http://anttrader.io) adapter for the [BitMEX](https://bitmex.com) cryptocurrency exchange.

The `ant-bitmex` crate provides strongly-typed client bindings (HTTP & WebSocket), data
...
See [the docs](https://docs.rs/ant-bitmex) for more detailed usage.
