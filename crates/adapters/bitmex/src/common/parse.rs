...
use ant_core::{nanos::UnixNanos, uuid::UUID4};
use ant_model::{
...
/// Parses a ant instrument ID from the given BitMEX `symbol` value.
#[must_use]
...
/// Maps BitMEX currency codes to standard ant currency codes.
///
...
/// Parses a BitMEX margin message into a ant account state.
///
/// # Errors
///
...
mod tests {
    use chrono::TimeZone;
    use ant_model::enums::AccountType;
    use rstest::rstest;
    use ustr::Ustr;
