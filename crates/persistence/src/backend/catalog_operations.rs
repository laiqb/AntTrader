...
use ant_model::data::{Data, HasTsInit};
...
///
/// ```rust,no_run
/// use ant_persistence::backend::catalog_operations::ConsolidationQuery;
///
        ...
        for directory in leaf_directories {
            ...
            if let Some(data_cls_name) = data_cls {
                ...
                match data_cls_name.as_str() {
                    ...
                    "order_book_deltas" => {
                        use ant_model::data::OrderBookDelta;
                    ...
                    "order_book_depths" => {
                        use ant_model::data::OrderBookDepth10;
                    ...
                    "index_prices" => {
                        use ant_model::data::IndexPriceUpdate;
                    ...
                    "mark_prices" => {
                        use ant_model::data::MarkPriceUpdate;
                    ...
                    "instrument_closes" => {
                        use ant_model::data::close::InstrumentClose;
