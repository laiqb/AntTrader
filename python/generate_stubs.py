#!/usr/bin/env python3
"""
Custom build script for ant-trader v2 with automatic stub generation.
...
def generate_stubs():
    ...
    stub_dirs = list(target_dir.glob("_libant*"))
    ...
    dest_dir = Path(__file__).parent / "ant_trader"
    ...
    print("Type stubs copied to ant_trader/")
    return True
...
def main():
    parser = argparse.ArgumentParser(description="Ant Trader v2 build script")
    parser.add_argument(
        "action",
        nargs="?",
        default="stubs",
    ...
    print(f"Starting ant-trader v2 {args.action}...")
