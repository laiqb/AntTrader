...
[![Documentation](https://img.shields.io/docsrs/ant-live)](https://docs.rs/ant-live/latest/ant-live/)
[![crates.io version](https://img.shields.io/crates/v/ant-live.svg)](https://crates.io/crates/ant-live)
...
Live system node for [antTrader](http://anttrader.io).

The `ant-live` crate provides high-level abstractions and infrastructure for running live trading
...
See [the docs](https://docs.rs/ant-live) for more detailed usage.
