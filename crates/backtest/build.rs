...
//! Build script for the `ant-backtest` crate.
//!
...
fn main() {
    ...
    if env::var("CARGO_FEATURE_FFI").is_ok() {
        ...
        let c_header_path = crate_dir.join("../../ant_trader/core/includes/backtest.h");
        ...
        let cython_path = crate_dir.join("../../ant_trader/core/rust/backtest.pxd");
