...
use ant_serialization::arrow::{DecodeDataFromRecordBatch, EncodeToRecordBatch};
...
impl ParquetDataCatalog {
    ...
    ///
    /// ```rust,no_run
    /// use ant_model::data::{QuoteTick, TradeTick, Bar};
    /// use ant_persistence::backend::catalog::ParquetDataCatalog;
    /// use ant_core::UnixNanos;
    ///
    /// let mut catalog = ParquetDataCatalog::new(/* ... */);
    ...
    {
        let rt = ant_common::runtime::get_runtime();
        rt.block_on(future)
    }
}
...
///
/// ```rust
/// use ant_persistence::backend::catalog::CatalogPathPrefix;
/// use ant_model::data::QuoteTick;
///
...
///
/// ```rust
/// # use ant_persistence::backend::catalog::timestamps_to_filename;
/// # use ant_core::UnixNanos;
...
///
/// ```rust
/// # use ant_persistence::backend::catalog::iso_timestamp_to_file_timestamp;
...
///
/// ```rust
/// # use ant_persistence::backend::catalog::file_timestamp_to_iso_timestamp;
...
///
/// ```rust
/// # use ant_persistence::backend::catalog::iso_to_unix_nanos;
...
///
/// ```rust
/// # use ant_persistence::backend::catalog::urisafe_instrument_id;
...
///
/// ```rust
/// # use ant_persistence::backend::catalog::make_local_path;
...
///
/// ```rust
/// # use ant_persistence::backend::catalog::make_object_store_path;
...
/// ```rust
/// # use std::path::PathBuf;
/// # use ant_persistence::backend::catalog::local_to_object_store_path;
...
///
/// ```rust
/// # use ant_persistence::backend::catalog::extract_path_components;
...
///
/// ```rust
/// # use ant_persistence::backend::catalog::query_intersects_filename;
...
///
/// ```rust
/// # use ant_persistence::backend::catalog::parse_filename_timestamps;
...
///
/// ```rust
/// # use ant_persistence::backend::catalog::are_intervals_disjoint;
/// // Disjoint intervals
...
///
/// ```rust
/// # use ant_persistence::backend::catalog::are_intervals_contiguous;
...
///
/// ```rust
/// # use ant_persistence::backend::catalog::query_interval_diff;
