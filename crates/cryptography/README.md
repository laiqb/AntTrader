...
[![Documentation](https://img.shields.io/docsrs/ant-cryptography)](https://docs.rs/ant-cryptography/latest/ant-cryptography/)
[![crates.io version](https://img.shields.io/crates/v/ant-cryptography.svg)](https://crates.io/crates/ant-cryptography)
...
Cryptographic utilities and security functions for [antTrader](http://anttrader.io).

The `ant-cryptography` crate provides essential cryptographic primitives and security utilities
...
See [the docs](https://docs.rs/ant-cryptography) for more detailed usage.
