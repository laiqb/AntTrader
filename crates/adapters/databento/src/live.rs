...
use ant_core::{UnixNanos, consts::ANT_USER_AGENT, time::get_atomic_clock_realtime};
use ant_model::{
...
/// Handles instrument definition messages and decodes them into ant instruments.
///
/// # Errors
///
