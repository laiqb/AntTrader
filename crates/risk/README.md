...
[![Documentation](https://img.shields.io/docsrs/ant-risk)](https://docs.rs/ant-risk/latest/ant-risk/)
[![crates.io version](https://img.shields.io/crates/v/ant-risk.svg)](https://crates.io/crates/ant-risk)
...
Risk engine for [antTrader](http://anttrader.io).

The `ant-risk` crate provides comprehensive risk management capabilities including pre-trade
...
See [the docs](https://docs.rs/ant-risk) for more detailed usage.
