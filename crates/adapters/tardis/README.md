...
[![Documentation](https://img.shields.io/docsrs/ant-tardis)](https://docs.rs/ant-tardis/latest/ant-tardis/)
[![crates.io version](https://img.shields.io/crates/v/ant-tardis.svg)](https://crates.io/crates/ant-tardis)
...
[antTrader](http://anttrader.io) adapter for [Tardis](https://tardis.dev).

The `ant-tardis` crate provides integration with the Tardis API for accessing
...
See [the docs](https://docs.rs/ant-tardis) for more detailed usage.
