...
use ant_core::consts::ANT_USER_AGENT;
use ant_model::defi::{Block, Chain, rpc::RpcNodeWssResponse};
use ant_network::websocket::{WebSocketClient, WebSocketConfig, channel_message_handler};
...
impl CoreBlockchainRpcClient {
    ...
    pub async fn connect(&mut self) -> anyhow::Result<()> {
        ...
        let user_agent = (USER_AGENT.to_string(), ANT_USER_AGENT.to_string());
