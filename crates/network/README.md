...
[![Documentation](https://img.shields.io/docsrs/ant-network)](https://docs.rs/ant-network/latest/ant-network/)
[![crates.io version](https://img.shields.io/crates/v/ant-network.svg)](https://crates.io/crates/ant-network)
...
Network functionality for [antTrader](http://anttrader.io).

The `ant-network` crate provides networking components including HTTP, WebSocket, and raw TCP socket
...
See [the docs](https://docs.rs/ant-network) for more detailed usage.
